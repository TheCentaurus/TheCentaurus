        ...
        <div className="z-20 flex flex-col items-center lg:items-stretch lg:flex-row justify-between mt-10">
          ...
          <div className="z-20  dark:bg-[#1b1324] bg-[#ffffff] lg:w-1/2 rounded-xl p-5 dark:text-white text-[#413A5A] mb-5 font-medium">
            ...
            <div className="z-20 w-full">
              ...
              <label
                htmlFor="file"
                className="z-20 cursor-pointer text-[#8175A7] text-sm border-[1px] dark:border-yellow-300 border rounded-xl py-2 px-8 w-full text-center flex justify-center items-center"
              >
                Upload Image
              </label>
            </div>
            <div className="z-20 w-full mt-5">
              ...
              <select
                name="category"
                id="category"
                className="z-20 w-full mt-2 dark:bg-[#1b1324] bg-[#ffffff] dark:text-white text-[#413A5A] border-[1px] dark:border-yellow-300 border rounded-xl py-2 px-8"
              >
            ...
            <div className="z-20 w-full mt-5">
              ...
              <input
                type="text"
                className="z-20 w-full mt-2 mb-2 dark:bg-[#1b1324] bg-[#ffffff] dark:text-white text-[#413A5A] border-[1px] dark:border-yellow-300 border rounded-xl py-2 px-8"
              />
              ...
              <div className="z-20 flex ">
                <button className="z-20 m-auto px-8 py-2 border-[1px] dark:border-yellow-300 border-[#1b1324] rounded-lg mt-5">
                  Create Contract
                </button>
              </div>
            </div>
          </div>
          <div className="z-20 mb-5 dark:bg-[#1b1324] bg-[#ffffff] lg:w-1/4 rounded-xl p-5 dark:text-white text-[#413A5A]">
            {/* preview image */}
            <div className="z-20 w-full">
