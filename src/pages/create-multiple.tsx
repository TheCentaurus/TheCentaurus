  ...
  return (
    <Layout>
      <div className="z-20 px-8 pt-10 my-16 md:px-15 lg:px-20 lg:pt-32">
        <div className="py-2">
          <h1 className="text-3xl font-bold text-yellow-300">Create Collection</h1>
        </div>
          ...
          <div className="px-4 py-5 bg-white shadow sm:rounded-lg sm:p-6">
            <div className="md:grid md:grid-cols-3 md:gap-6">
              <div className="md:col-span-1">
                <h3 className="text-lg font-medium leading-6 text-gray-900">Logo Image*</h3>
             ...
             <div className="md:grid md:grid-cols-3 md:gap-6">
              <div className="md:col-span-1">
                <h3 className="text-lg font-medium leading-6 text-gray-900">Banner Image</h3>
                <p className="mt-1 text-sm text-gray-500">
                  This image will appear top of your collection page. 1400 x 350 recommended.
                </p>
              </div>
              <div className="md:col-span-2">
             ...
             <div className="md:grid md:grid-cols-3 md:gap-6">
              <div className="md:col-span-1">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  This image will be used for the featured image on the home page.600 x 400 recommended.
                </p>
              </div>
              <div className="md:col-span-2">
