    ...
    <div className="px-5 lg:px-0 lg:pb-10">
      ...
      <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 lg:mx-40 ">
        <motion.div
          ...
          viewport={{ amount: 0.2 }}
          className="max-w-md p-4 bg-[#1B1324] rounded-lg shadow-md sm:p-8 m-4 text-center"
        >
          <div className="bg-[#6164ff26] p-2 rounded-lg w-fit m-auto">
            <BiWallet className="text-[48px] text-[#67696d] text-center m-auto" />
          </div>
        ...
        <motion.div
          ...
          className="max-w-md p-4 bg-[#1B1324] rounded-lg shadow-md sm:p-8 m-4 text-center"
        >
          <div className="bg-[#25a56a26] p-2 rounded-lg w-fit m-auto">
            <svg
              width="47"
              height="48"
              viewBox="0 0 47 48"
        ...
        <motion.div
          ...
          className="max-w-md p-4 bg-[#1B1324] rounded-lg shadow-md sm:p-8 m-4 text-center"
        >
          <div className="bg-[#8051d426] p-2 rounded-lg w-fit m-auto">
            <BiImageAdd className="text-[48px] text-[#8051d4]" />
          </div>
        ...
        <motion.div
          ...
          className="max-w-md p-4 bg-[#1B1324] rounded-lg shadow-md sm:p-8 m-4 text-center"
        >
          <div className="bg-[#eb575726] p-2 rounded-lg w-fit m-auto">
            <AiFillTag className="text-[48px] text-[#eb5757]" />
          </div>
          <h1 className="py-2 font-light text-[#E6E0FA]">List them for sale</h1>
          <p className="text-sm font-light text-[#8175A7]">
            Choose between auctions, fixed-price listings, and declining-price
